...
def process_varieties(species_id):
    ...
    if response.status_code == 200:
        ...
        for variety in varieties:
            ...
            if any(excluded in name for excluded in ["-mega", "-gmax", "-alola", "-hisui", "-galar", "-rock-star", "-belle", "-pop-star", "-phd", "-libre", "-cosplay", "-original-cap", "-hoenn-cap", "-sinnoh-cap", "-unova-cap", "-kalos-cap", "-partner-cap", "-starter", "-world-cap", "-primal", "-paldea", "-totem", "-origin"]):
                continue
